...
# Na próxima parte dividimos os numeros e indices, 
...
resto_divisao_11 = multip_por_10 % 11 # Pegando o resto da divisão por 11
confimacao_cpf_1 = resto_divisao_11 if resto_divisao_11 <= 9 else 0 # Caso passe de 9 adiciona 0, caso não é o valor normal
CPF_INT.append(confimacao_cpf_1) # Pegamos o digito gerado e adicionamos ao CPF
...
# Mesmo processo do anterior + primeiro digito
